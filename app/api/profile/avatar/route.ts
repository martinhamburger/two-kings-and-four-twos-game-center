...
import {boundedImage,discardUnreadBody,profile,sameOrigin} from '@/lib/avatar/server';
...
async function change(req:Request,remove:boolean){return safe(async()=>{try{
 ...
 }finally{await discardUnreadBody(req).catch(()=>{});}
});}
