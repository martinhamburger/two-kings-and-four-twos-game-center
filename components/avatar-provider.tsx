...
import {useFriends,useFriendsRefresh} from './friends-provider';
...
export function useRoomAvatarSync(code?:string){const refresh=useFriendsRefresh();useEffect(()=>{if(code)void refresh()},[code,refresh]);}
